        ...
        if (title.length == 0) {
            ...
            try {
                ...
                if (index > -1) {
                    ...
                    newTasks = [...tasks, Task];//this will add the task at bottom of the list if it's index is not available or task is not created with certain index else list will be updated
                }
